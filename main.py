...
bot = telebot.TeleBot('5187705156:AAF1TW00P9Xz-dgIlcqtjmP7VydXahmB0DI')  # Создаем экземпляр бота
...
def get_text_messages(message):
    ...
    if Menu.cur_menu != None and ms_text in Menu.cur_menu.buttons:  # проверим, что команда относится к текущему меню
        ...
        if ms_text == "Помощь":
            ...
            bot.send_photo(chat_id, photo=get_dogURL(), caption="Вот тебе котик!")
